            ...
            <div className="h-screen bg-black flex flex-col">
                <div className="flex-1 flex">
                    ...
                    <div className="w-1/2">
                        ...
                        <br />
                        <button className="bg-white px-8 py-3 text-xl text-black font-semibold hover:border-white hover:border-2 hover:bg-black hover:text-white flex items-center">
                            <span>Resume</span>
