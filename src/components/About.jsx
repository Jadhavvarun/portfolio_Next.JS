  ...
  return (
    <div>
        ...
        <div className="flex flex-col md:flex-row px-6 md:px-28 py-12 md:py-28">
          <div className="md:w-1/2">
            ...
            <p className="text-white">
              ...
              and user-centered digital experiences. With 4 years of experience in the field. I am always looking for new
      ...
      <div className="bg-black py-12 md:py-24">
        <h2 className="text-4xl md:text-7xl font-bold text-center text-white mb-8">Skills</h2>
